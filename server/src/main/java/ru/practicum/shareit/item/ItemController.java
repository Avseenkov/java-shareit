...
public class ItemController {
    ...
    public ItemDto createItem(@RequestHeader("X-Sharer-User-Id") Long id, @RequestBody ItemDto itemDto) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public CommentDto createComment(@RequestHeader("X-Sharer-User-Id") Long id, @PathVariable long itemId, @RequestBody CommentDto commentDto) {
